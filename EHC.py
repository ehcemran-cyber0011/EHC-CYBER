...
RQS_ERR = "</> BDCYBER REQUESTS ERROR"
...
def MAIN_x_BDCYBER():
    ...
    print(f"\n{lgt}{y}{itl}{bgr}</> WARNING :{stp}{lgt}{y}{unl} This {r}\"BDCYBER SMS SPAM\"{y} Developed For {stp}")
    print(f"{lgt}{y}{itl}{unl} - Only Educational Purpose & Cyber Awerness ! {stp}")
    print(f"{lgt}{y}{itl}{unl} - We {r}\"BD CYBER TEAM CYBER\"{y} Are Not Promoted For {stp}")
    ...
    if not number.isdigit() or len(number) != 11:
        ...
        time.sleep(2);MAIN_x_BDCYBER()
    elif "BDCYBER" in number:
        Lxj(f"{c}<{w}/{c}> {y}Invalid Number Try Again ! ")
        time.sleep(2);MAIN_x_BDCYBER()
...
def DARKS(number,amo):
    ...
    Lxj(f"{c} <{w}/{c}> {g}⚡ BDCYBER SMS SPAM {r}v7.0 {g}STARTED\n")
    Lxj(f"{c} <{w}/{c}> {g}VICTIM {w}|{g} AMOUNT {c}➤ {r}"+str(number)+f"{c} | {r}"+str(amo)+"\n")
    lnx()
    for x in range(amo):
        x+=1
        lmnXlija_1(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-01]")
        lmnXlija_2(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-02]")
        lmnXlija_3(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-03]")
        lmnXlija_4(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-04]")
        lmnXlija_5(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-05]")
        lmnXlija_6(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-06]")
        lmnXlija_7(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-07]")
        lmnXlija_8(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-08]")
        lmnXlija_9(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-09]")
        lmnXlija_10(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-10]")
        lmnXlija_11(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-11]")
        lmnXlija_12(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-12]")
        lmnXlija_13(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-13]")
        lmnXlija_14(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-14]")
        lmnXlija_15(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-15]")
        lmnXlija_16(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-16]")
        lmnXlija_17(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-17]")
        lmnXlija_18(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-18]")
        lmnXlija_19(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-19]")
        lmnXlija_20(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-20]")
        lmnXlija_21(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-21]")
        lmnXlija_22(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-22]")
        lmnXlija_23(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-23]")
        lmnXlija_24(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-24]")
        lmnXlija_25(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-25]")
        lmnXlija_26(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-26]")
        lmnXlija_27(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-27]")
        lmnXlija_28(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-28]")
        lmnXlija_29(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-29]")
        lmnXlija_30(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-30]")
        lmnXlija_31(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-31]")
        lmnXlija_32(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-32]")
        lmnXlija_33(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-33]")
        lmnXlija_34(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-34]")
        lmnXlija_35(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-35]")
        lmnXlija_36(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-36]")
        lmnXlija_37(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-37]")
        lmnXlija_38(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-38]")
        lmnXlija_39(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-39]")
        lmnXlija_40(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-40]")
        lmnXlija_41(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-41]")
        lmnXlija_42(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-42]")
        lmnXlija_43(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-43]")
        lmnXlija_44(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-44]")
        lmnXlija_45(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-45]")
        lmnXlija_46(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-46]")
        lmnXlija_47(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-47]")
        lmnXlija_48(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-48]")
        lmnXlija_49(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-49]")
        lmnXlija_50(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-50]")
        lmnXlija_51(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-51]")
        lmnXlija_52(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-52]")
        lmnXlija_53(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-53]")
        lmnXlija_54(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-54]")
        lmnXlija_55(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-55]")
        lmnXlija_56(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-56]")
        lmnXlija_57(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-57]")
        lmnXlija_58(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-58]")
        lmnXlija_59(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-59]")
        lmnXlija_60(number);BDCYBER(f" </> BDCYBER v7.0 [{x}-60]")
    lnx()
